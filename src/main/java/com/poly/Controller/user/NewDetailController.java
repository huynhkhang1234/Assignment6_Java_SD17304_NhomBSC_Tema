 ...
 * 
 * import com.poly.DAO.NewsDAO; import com.poly.Entities.News;
 * 
 * @Controller public class NewDetailController {
 * 
 * @Autowired NewsDAO dao;
 * 
 * @GetMapping("/user/news/detail") public String view(Model model) { News
 * entity = new News(); model.addAttribute("news", entity);
 * 
 * 
 * List<News> list = dao.findAllActiveTrue();
 * 
 * model.addAttribute("list", list); return "user/news-detail"; }
 * 
 * 
 * 
